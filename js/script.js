const typedTextSpan = document.querySelector(".typed-text"),
    textArray = ["Disiplin adalah kunci keberhasilan seseorang", "Belajar tanpa henti adalah cara untuk mempunyai pengetahuan luas","Hiduplah seolah-olah kamu akan mati besok. Belajarlah seolah-olah Anda akan hidup selamanya","Hasil tertinggi dari pendidikan adalah toleransi","Belajar tanpa berpikir adalah pekerjaan yang sia-sia, berpikir tanpa belajar itu berbahaya","Seseorang yang tidak mau membaca tidak memiliki kelebihan dibandingkan orang yang tidak bisa membaca"],
    typingDelay = 200,
    erasingDelay = 100,
    newTextDelay = 2e3;
